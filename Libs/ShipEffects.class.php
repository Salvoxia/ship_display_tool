 ...
 */
	public static function findEffectName($_input, $_bonus) {
		...
		|| strstr($_input,"explosion velocity")
                || strstr($_input,"while sharpshooter") // ignore T3 destroyer sharpshooter mode dependent role bonuses
                || strstr($_input,"while propulsion") // ignore T3 destroyer propulsion mode dependent role bonuses
